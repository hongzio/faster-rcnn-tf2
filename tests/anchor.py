...
class TestAnchor(unittest.TestCase):
    ...
    def test_transform(self):
        bboxes = tf.convert_to_tensor([[0.18494931, 0.9435849, 0.03049111, 0.96302897, 0],
                                       [0.01586703, 0.17582396, 0.35938117, 0.6069674, 56],
                                       [0.09158827, 0.26967454, 0.48252046, 0.6403017, 67]])
